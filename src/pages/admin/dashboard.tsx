				...
				{categorySales.map((c) => (
					...
					>
						<span
							...
							style={{
								backgroundColor:
									categoryColors[c.name as keyof typeof categoryColors],
							}}
						/>
			...
			<div className="grid grid-cols-2 lg:grid-cols-4 gap-4 lg:gap-6">
				{stats.map((s) => (
					<StatCard
						...
						color={s.color as "blue" | "green" | "orange" | "violet" | "amber"}
						delta={s.delta}
							...
							>
								<div className="flex flex-col gap-1">
									<div className="flex items-center gap-2">
										...
										<Badge color={orderStatus[o.status as OrderStatus].color}>
											{orderStatus[o.status as OrderStatus].label}
										</Badge>
									</div>
